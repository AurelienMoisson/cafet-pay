...
aurelien_id = db.find_id('aurelien.moisson-franckhauser@grenoble-inp.org','aurelien', 'moisson')
...
assert db.find_account(aurelien_id) == ('aurelien.moisson-franckhauser@grenoble-inp.org','aurelien', 'moisson')
